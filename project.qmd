...
<div style="position:fixed; left:0; top:0; width:250px; height:100%; background:#f8f9fa; padding:1em; padding-top:3em;">
  <h4>Links</h4>
  <ul>
    <li><a href="project_proposal.qmd">Project Proposal</a></li>
    <li><a href="bode_plot_demo.qmd">Interactive 3-Band EQ Simulator</a></li>
    <li><a href="IIR_filter.qmd">IIR Filter Math and Calculations</a></li>
    <li><a href="midpoint_checkoff.qmd">Midpoint Checkoff</a></li>
    <li><a href="final_checkoff.qmd">Final Checkoff</a></li>
  </ul>
</div>

<div style="margin-left:100px; padding:1em;">
